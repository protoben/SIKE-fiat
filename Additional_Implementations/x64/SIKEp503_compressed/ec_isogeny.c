...
/**
 * Computes [3^e](X:Z) on Montgomery curve with projective constant via e repeated triplings.
 * e triplings in E costs k*(5M + 6S + 9A)
...
void Mont_ladder(const f2elm_t x, const digit_t* m, point_proj_t P, point_proj_t Q, const f2elm_t A24, 
...
void mont_twodim_scalarmult(digit_t* a, const point_t R, const point_t S, const f2elm_t A, 
                            const f2elm_t A24, point_full_proj_t P, const unsigned int order_bits)
{ // Computes P = R + [a]S  
