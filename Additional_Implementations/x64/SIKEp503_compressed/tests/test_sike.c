...
*
* Abstract: benchmarking/testing isogeny-based key encapsulation mechanism with key compression support
*********************************************************************************************/ 
...
{ // Testing KEM
    ...
    printf("\n\nTESTING ISOGENY-BASED KEY ENCAPSULATION MECHANISM WITH KEY COMPRESSION SUPPORT %s\n", SCHEME_NAME);
    printf("--------------------------------------------------------------------------------------------------------\n\n");
    ...
    for (i = 0; i < TEST_LOOPS; i++) 
    {
        ...
        if (memcmp(ss, ss_, CRYPTO_BYTES) != 0) {
            printf("  KEM Test %d failed\n", i);
            passed = false;
            break;
        }
    }

    if (passed == true) printf(" %d KEM tests .................................................... PASSED", TEST_LOOPS);
